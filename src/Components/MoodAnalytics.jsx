...
const MoodAnalytics = ({ moods }) => {
  ...
  return (
    <div className="mood-analytics text-center mb-6">
      <h2 className="text-xl font-semibold mb-3">Mood Analytics</h2>
      ...
      <p className="text-3xl font-medium text-gray-800"> Summary </p>
        ...
        <p className="text-md">Mood Distribution:</p>
        <div className="mood-summary mt-3">
